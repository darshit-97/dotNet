...
void DisplayAdjustedTime(int[] times, int currentGMT, int newGMT)
{
    ...
    for (int i = 0; i < times.Length; i++)
    {
        ...
        Console.WriteLine($"{times[1]} -> {newTime}");
    }
} */
...
int[] TwoCoins(int[] coins, int target)
{
    ...
    {
        // Console.WriteLine($"Current Object: {coins[curr]}");
        for (int next = curr + 1; next < coins.Length; next++)
        {
            // Console.WriteLine($"Current Next Object: {coins[next]}");
            // Console.WriteLine($"Current Object + Current Next Object: {coins[curr]} + {coins[next]} == {coins[curr]+coins[next]}");
            // Console.WriteLine("--------------------------------------------");
